...
const SignupForm = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (password === confirmPassword) {
      ...
      setErrors((prev) => [
        ...prev,
        "Password confirmation field does not match password field.",
      ]);
    }
  };
  ...
  return (
    <>
      <AuthFormTab />
      <form
        className="tw-bg-white tw-w-auto tw-m-auto tw-flex tw-flex-col tw-justify-between tw-p-8 tw-border-2 tw-border-black tw-rounded-lg"
        onSubmit={onSubmit}
      >
