  ...
  return (
    <div>
      <div className="tw-min-h-screen tw-mx-auto">
        <h1 className="tw-text-white tw-text-4xl tw-p-4 tw-font-semibold tw-text-center">
          {user.username}
        </h1>
        {drinks.length > 0 && (
          <>
            <hr className="tw-border-white" />
            <h3 className="tw-text-xl tw-text-white tw-text-center tw-p-2">
              Drinks by {user.username}
            </h3>
            <ul>
              {drinks?.map((drink) => (
                <div
                  className="tw-flex tw-justify-center tw-p-4"
                  key={drink.id}
                >
                  <Drink drink={drink} />
                </div>
        ...
        {reviews.length > 0 && (
          <>
            <hr className="tw-border-white" />
            <h3 className="tw-text-xl tw-text-white tw-text-center tw-p-2">
              {user.username}'s Reviews of Drinks
            </h3>
            <ul>
              {reviews?.map((review) => (
